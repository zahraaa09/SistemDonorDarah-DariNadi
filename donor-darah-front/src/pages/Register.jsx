...
import api from "../services/api"; // Menembak Axios config pusat

// --- Ikon SVG Sesuai Desain Mockup Jaringan DariNadi ---
const BloodDropIcon = () => (
...
export default function Register({ onNavigate }) {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white font-sans antialiased">
      ...
      {/* ⚪ SISI KANAN: AREA INPUT FORMULIR */}
      <div className="flex flex-col min-h-screen overflow-y-auto">
        
        {/* HEADER BAR: Hanya berisi Logo dan Tombol Kecil untuk Back */}
        ...
        {/* Pembungkus Inti Formulir Tengah */}
