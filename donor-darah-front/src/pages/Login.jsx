...
import api from "../services/api"; // Hubungkan ke axios config

// --- Ikon SVG Sesuai Desain Grafis Jaringan DariNadi ---
const BloodDropIcon = () => (
...
export default function Login({ onNavigate, onLoginSuccess }) {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white font-sans antialiased">
      ...
      {/* 🔴 SISI KIRI: MURNI FULL IMAGE COVER */}
      ...
      {/* ⚪ SISI KANAN: AREA INPUT FORMULIR LOGIN */}
      <div className="flex flex-col min-h-screen overflow-y-auto bg-white">
        
        {/* HEADER BAR: Penyelarasan padding bar atas agar pas dengan form */}
        ...
        {/* 🛠️ DIPERBAIKI: Mengubah 'justify-center' menjadi 'justify-start pt-12' agar form naik mendekati header */}
        <div className="flex-1 flex flex-col justify-start items-center px-8 lg:px-16 pb-12 pt-4">
          <div className="w-full max-w-lg">
            
            {/* Judul & Subjudul Sesuai Mockup image_90a10b.jpg */}
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1.5">Email atau No. Telp</label>
                <input
                  type="text"
                  name="identifier"
